		...
		questions: function () {
			return [
				...
				},
				{
					title: `কোর্স ফি?`,
					content: `
						কোর্স ফি ১০০০০/- বর্তমানে ৮০০০, লাইভ ক্লাস ১৮০০০/- বর্তমানে ১৫০০০।
					`,
				},
				{
					title: `ফুলস্ট্যাক ওয়েব ডেভেলপমেন্ট উইথ মার্নস্ট্যাক কোর্সের ইন্সট্রাকটর সম্পর্কে আরো কীভাবে জানতে পারবো?`,
					content: `
